...
class ArticleList(ListView):
    ...
    template_name = 'index.html'  # указываем имя шаблона, в котором будет лежать HTML, в котором будут все инструкции о том, как именно пользователю должны вывестись наши объекты
...
class ArticleDetail(DetailView):
    ...
    template_name = 'index.html'  # название шаблона будет product.html
